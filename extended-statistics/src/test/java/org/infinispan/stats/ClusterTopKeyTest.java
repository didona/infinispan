 ...
 * @since 5.3
 */
@Test(groups = "functional", testName = "stats.ClusterTopKeyTest")
public abstract class ClusterTopKeyTest extends MultipleCacheManagersTest {

   protected final CacheMode cacheMode;
   private final int clusterSize;
   private final AtomicInteger threadCounter = new AtomicInteger(0);

   protected ClusterTopKeyTest(CacheMode cacheMode, int clusterSize) {
